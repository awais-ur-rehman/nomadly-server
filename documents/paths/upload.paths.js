...
exports.uploadPaths = {
    "/api/upload/image": {
        post: {
            ...
            description: "Upload an image file to Cloudinary and get back the URL. Use the returned URL in other APIs (profile photo, activity images, etc.). **Requires authentication.**",
            security: [{ bearerAuth: [] }],
            parameters: [
                {
                    name: "type",
                    ...
                    description: "Type of upload - determines folder structure (profile, activity, rig, chat, default)",
                },
            ],
            requestBody: {
                required: true,
    ...
    "/api/upload/image/{publicId}": {
        delete: {
            ...
            description: "Delete an image from Cloudinary using its public_id. **Requires authentication.**",
            security: [{ bearerAuth: [] }],
            parameters: [
                {
                    name: "publicId",
