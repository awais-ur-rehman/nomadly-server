...
async function seedUsers(): Promise<string[]> {
    ...
    for (const userData of testUsers) {
        ...
        const matchingProfiles = [
            { name: "Alice Climber", bio: "Looking for climbing partners 🧗‍♂️", intent: "friends", hobby: "Climbing" },
            { name: "Bob Vanlife", bio: "Solo traveler in a Sprinter 🚐", intent: "dating", hobby: "Vanlife" },
            { name: "Charlie Hiker", bio: "Love long distance trails 🥾", intent: "friends", hobby: "Hiking" },
            { name: "Diana Yoga", bio: "Teaching yoga on the road 🧘‍♀️", intent: "both", hobby: "Yoga" },
            { name: "Evan Surfer", bio: "Chasing waves along the coast 🏄‍♂️", intent: "friends", hobby: "Surfing" },
            { name: "Fiona Foodie", bio: "Cooking local ingredients 🍳", intent: "dating", hobby: "Cooking" },
            { name: "George Guitar", bio: "Campfire songs every night 🎸", intent: "friends", hobby: "Music" },
            { name: "Hannah Photo", bio: "Capturing the journey 📸", intent: "both", hobby: "Photography" },
            { name: "Ian Tech", bio: "Digital nomad setup expert 💻", intent: "friends", hobby: "Tech" },
            { name: "Julia Art", bio: "Painting landscapes 🎨", intent: "dating", hobby: "Art" },
            { name: "Kevin Biker", bio: "Mountain biking trails only 🚵‍♂️", intent: "friends", hobby: "Biking" },
            { name: "Luna Star", bio: "Astrophotography enthusiast ✨", intent: "both", hobby: "Stargazing" },
            { name: "Max Dog", bio: "Traveling with my husky 🐕", intent: "friends", hobby: "Pets" },
            { name: "Nina Read", bio: "Books and hammocks 📚", intent: "dating", hobby: "Reading" },
            { name: "Oscar Dive", bio: "Scuba diving whenever near ocean 🤿", intent: "friends", hobby: "Diving" },
        ];
        ...
        for (const profile of matchingProfiles) {
            ...
            // Coordinates near San Francisco (test user default)
            const lat = 37.7749 + (Math.random() - 0.5) * 0.1; // Within ~10km
            ...
            const user = await User.create({
                ...
                travel_route: {
                    ...
                    destination: { type: "Point", coordinates: [lng + 1, lat + 1] }, // Just somewhere
                    start_date: new Date(),
                    duration_days: 90,
                },
                is_builder: false,
                nomad_id: { verified: Math.random() > 0.5, member_since: new Date(), vouch_count: 5 },
            ...
            userIds.push(user._id.toString());
            console.log(`  Created matching user: ${profile.name}`);
        }
